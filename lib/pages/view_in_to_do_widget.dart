...
class ViewInToDoWidget extends StatefulWidget {
  const ViewInToDoWidget({Key key}) : super(key: key);

  @override
  _ViewInToDoWidgetState createState() => _ViewInToDoWidgetState();
}

class _ViewInToDoWidgetState extends State<ViewInToDoWidget> {
